...
import com.knauff.mike.serviceframework.processors.Resource1Processor;
 ...
 */
@Component
@Path("resource/v0/resource1")
public class RestAppResourceHandler1 {
	 ...
	 * 
	 */
	public RestAppResourceHandler1() {
		
		this.processor = new Resource1Processor();
	}
